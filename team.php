...
<head>
  ...
  <title>Seven Dimensions Team</title>
  ...
  <div class="parentContainer">
    ...
    <div class="navBody">
      ...
      <li><a href="index.php">home</a></li>
        ...
        <li><a href="teamAr.php">arabic</a></li>
      </ul>
    </div>
  </div>
    ...
    <div class="mainSec justifyContentCenter alignItemsCenter">
      <div class="content">
        <div class="team justifyContentCenter alignItemsCenter flexDirectionCol">
          <h2 class="special-header" data-aos="fade-in" data-aos-delay="50">our team</h2>
          <div class="teamBlock">
            <div class="teamMember" data-aos="fade-left" data-aos-delay="50">
              <img src="img/Team/MuathAldoweesh.webp" alt="" class="teamMedia" />
              <div class="teamOverlay justifyContentCenter alignItemsCenter">
                <h3>Muath Aldoweesh</h3>
                <h2>C.E.O</h2>
              </div>
            </div>
            <div class="teamMember" data-aos="fade-left" data-aos-delay="100">
            ...
            <div class="teamMember" data-aos="fade-left" data-aos-delay="150">
            <img src="img/Team/MohamedBakhet.webp" alt="" class="teamMedia" />
              <div class="teamOverlay justifyContentCenter alignItemsCenter">
                <h3>Mohamed Bakhat</h3>
                <h2>art director</h2>
              </div>
            </div>
            <div class="teamMember" data-aos="fade-left" data-aos-delay="200">
              <img src="img/Team/Girl.webp" alt="" class="teamMedia" />
              <div class="teamOverlay justifyContentCenter alignItemsCenter">
                <h3>Alanoud Alarfaj</h3>
