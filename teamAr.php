...
<head>
  ...
  <title>فريق عمل Seven Dimensions</title>
...
<body>
  <div class="parentContainer">
    ...
    <div class="pageOverlay"></div>
      <img src="img/Team/Team.webp" width="100%" alt="">
      <nav>
    ...
    <div class="navBody">
      ...
      <li><a href="indexAr.php">الرئيسية</a></li>
        ...
        <li><a href="team.php">الإنجليزية</a></li>
      </ul>
    </div>
  </div>
  ...
  <div class="container" id="web">
    ...
    <div class="mainSec justifyContentCenter alignItemsCenter">
      <div class="content">
        <div class="team justifyContentCenter alignItemsCenter flexDirectionCol">
          <h2 class="special-header" data-aos="fade-in" data-aos-delay="50">فريقنا</h2>
          <div class="teamBlock">
          <div class="teamMember" data-aos="fade-right" data-aos-delay="50">
              <img src="img/Team/MuathAldoweesh.webp" alt="" class="teamMedia" />
              <div class="teamOverlay justifyContentCenter alignItemsCenter">
                <h3>معاذ الدويش</h3>
                <h2>المدير التنفيذي</h2>
              </div>
            </div>
            <div class="teamMember" data-aos="fade-right" data-aos-delay="100">
              <img src="img/Team/AhmedElnagar.webp" alt="" class="teamMedia" />
              <div class="teamOverlay justifyContentCenter alignItemsCenter">
                <h3>أحمد النجار</h3>
                <h2>المدير التسويقي</h2>
              </div>
            </div>
            <div class="teamMember" data-aos="fade-right" data-aos-delay="150">
            <img src="img/Team/MohamedBakhet.webp" alt="" class="teamMedia" />
              <div class="teamOverlay justifyContentCenter alignItemsCenter">
                <h3>محمد بخيت</h3>
                <h2>المدير الفني</h2>
              </div>
            </div>
            <div class="teamMember" data-aos="fade-right" data-aos-delay="200">
              <img src="img/Team/Girl.webp" alt="" class="teamMedia" />
              <div class="teamOverlay justifyContentCenter alignItemsCenter">
                <h3>العنود العرفج</h3>
                <h2>مدير وسائل التواصل الإجتماعي</h2>
              </div>
            </div>
            <div class="teamMember" data-aos="fade-right" data-aos-delay="50">
            <img src="img/Team/avatar.jpg" alt="" class="teamMedia" />
              <div class="teamOverlay justifyContentCenter alignItemsCenter">
                <h3>أحمد حته</h3>
                <h2>متخصص في التسويق</h2>
              </div>
            </div>
            <div class="teamMember" data-aos="fade-right" data-aos-delay="100">
            <img src="img/Team/Girl.webp" alt="" class="teamMedia" />
              <div class="teamOverlay justifyContentCenter alignItemsCenter">
                <h3>رهف الطريقي</h3>
                <h2>متخصص في وسائل تواصل اجتماعي</h2>
              </div>
            </div>
            <div class="teamMember" data-aos="fade-right" data-aos-delay="150">
            <img src="img/Team/YasserHemdan.webp" alt="" class="teamMedia" />
              <div class="teamOverlay justifyContentCenter alignItemsCenter">
                <h3>ياسر حمدان</h3>
                <h2>مصمم و مطور ويب</h2>
              </div>
            </div>
            <div class="teamMember" data-aos="fade-right" data-aos-delay="200">
            <img src="img/Team/DiaaEldinSabry.webp" alt="" class="teamMedia" />
              <div class="teamOverlay justifyContentCenter alignItemsCenter">
                <h3>ضياء الدين صبري</h3>
                <h2>متخصص في تكنولوجيا المعلومات</h2>
              </div>
            </div>
            <div class="teamMember" data-aos="fade-right" data-aos-delay="50">
            <img src="img/Team/Girl.webp" alt="" class="teamMedia" />
            ...
            <div class="teamMember" data-aos="fade-right" data-aos-delay="150">
            <img src="img/Team/AssemAlkhudheri.webp" alt="" class="teamMedia" />
              <div class="teamOverlay justifyContentCenter alignItemsCenter">
                <h3>عاصم الخضيري</h3>
                <h2>متخصص في التسويق</h2>
              </div>
            ...
            <div class="teamMember" data-aos="fade-right" data-aos-delay="200">
            <img src="img/Team/MohamedAshraf.webp" alt="" class="teamMedia" />
              <div class="teamOverlay justifyContentCenter alignItemsCenter">
                <h3>محمد اشرف</h3>
                <h2>متخصص في التسويق</h2>
              </div>
            ...
            <div class="teamMember" data-aos="fade-right" data-aos-delay="50">
            <img src="img/Team/MohamedFarouk.webp" alt="" class="teamMedia" />
              <div class="teamOverlay justifyContentCenter alignItemsCenter">
                <h3>محمد فاروق</h3>
                <h2>مدير مشروعات</h2>
              </div>
            ...
            <div class="teamMember" data-aos="fade-right" data-aos-delay="100">
            <img src="img/Team/ahmedTalaat.webp" alt="" class="teamMedia" />
              <div class="teamOverlay justifyContentCenter alignItemsCenter">
                <h3>أحمد طلعت</h3>
                <h2>مصمم رسوم متحركة</h2>
              </div>
            </div>
            
            <div class="teamMember" data-aos="fade-right" data-aos-delay="150">
            <img src="img/Team/MohamedMostafa.webp" alt="" class="teamMedia" />
              <div class="teamOverlay justifyContentCenter alignItemsCenter">
                <h3>محمد مصطفي</h3>
                <h2>خبير تصميم جرافيك</h2>
              </div>
            </div>
            <div class="teamMember" data-aos="fade-right" data-aos-delay="200">
            <img src="img/Team/OmarElsherif.webp" alt="" class="teamMedia" />
              <div class="teamOverlay justifyContentCenter alignItemsCenter">
                <h3>عمر الشريف</h3>
                <h2>خبير تصميم جرافيك</h2>
              </div>
            ...
            <div class="teamMember" data-aos="fade-right" data-aos-delay="50">
            <img src="img/Team/AhmedBakhet.webp" alt="" class="teamMedia" />
              <div class="teamOverlay justifyContentCenter alignItemsCenter">
                <h3>أحمد بخيت</h3>
                <h2>مصمم جرافيك</h2>
              </div>
            ...
            <div class="teamMember" data-aos="fade-right" data-aos-delay="100">
            <img src="img/Team/MohamedJamal.webp" alt="" class="teamMedia" />
              <div class="teamOverlay justifyContentCenter alignItemsCenter">
                <h3>محمد جمال</h3>
                <h2>مصمم جرافيك</h2>
              </div>
            ...
            <div class="teamMember" data-aos="fade-right" data-aos-delay="150">
            <img src="img/Team/AbdooTawfeek.webp" alt="" class="teamMedia" />
              <div class="teamOverlay justifyContentCenter alignItemsCenter">
                <h3>عبده توفيق</h3>
                <h2>مصمم جرافيك</h2>
              </div>
            ...
            <div class="teamMember" data-aos="fade-right" data-aos-delay="200">
            <img src="img/Team/omarGamal.webp" alt="" class="teamMedia" />
              <div class="teamOverlay justifyContentCenter alignItemsCenter">
                <h3>عمر جمال</h3>
                <h2>مصمم جرافيك</h2>
              </div>
